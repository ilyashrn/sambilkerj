<!-- Copyright -->
                        <div class="copyright">
                            <div class="pull-left">
                                &copy; 2016 Ilyas Habiburrahman powered by <strong>Aqvatarius</strong>. All rights reserved.
                            </div>
            ...
            <div class="dev-page-footer dev-page-footer-fixed"> <!-- dev-page-footer-closed dev-page-footer-fixed -->
                <ul class="dev-page-footer-controls">
                    ...
                    <li><a class="tip" title="Logoff" href="<?php echo base_url().'adm/logout';?>"><i class="fa fa-power-off"></i></a></li>
        ...
        <script type="text/javascript" src="<?php echo base_url().'assets/js/plugins/sortable/sortable.min.js'?>"></script>
