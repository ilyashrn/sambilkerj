                    ...
                    <div class="col-md-12">
                        ...
                        <div class="wrapper wrapper-white">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <button name="ins_Administrator" type="submit" class="btn btn-default">Regrister new Administrator</button>
                                    </div>
                                </div>
                            </div>
                              <?php
