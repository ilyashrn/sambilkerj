              ...
              <!-- <form class="form-horizontal"> -->
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    <button name="ins_edu" type="submit" class="btn btn-default" style="float:left;">Save</button>
              ...
              <span>Tambahkan pengalaman pekerjaan yang sudah pernah anda lakukan guna menunjang karir anda disini dan menarik para perekrut.</span>
                ...
                ?>
                  <!-- <form class="form-horizontal"> -->
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <button name="ins_exp" type="submit" class="btn btn-default" style="float:left;">Save</button>
                        <a href="../../<?php echo $username; ?>" name="cancel" class="btn btn-white">Cancel</a>
                      </div>
                    </div>
                  <?php
                  ...
                  <span>Tambahkan pengalaman pelatihan yang sudah pernah anda ikuti guna menunjang karir anda disini dan menarik para perekrut.</span>
                    ...
                    ?>
                      <!-- <form class="form-horizontal"> -->
                        ...
                        <div class="form-group">
                          <div class="col-sm-offset-2 col-sm-10">
                            <button name="ins_train" type="submit" class="btn btn-default" style="float:left;">Save</button>
                            <a href="../../<?php echo $username; ?>" name="cancel" class="btn btn-white">Cancel</a>
                          </div>
                        </div>
                      <?php
